...
def get_user_sheet(user_id):
    ...
    table_name = user_table_choice.get(user_id, "Основна таблиця")
...
def start_message(message):
    bot.send_message(message.chat.id,
                    ...
                    #  "Використай /table щоб обрати таблицю. Приклади повідомлень внизу =>\n"
                     ...
                     "📌❗️ Основна таблиця → \n"
                     "Приклад: Учень Учнівський, 15:00, Сокаль, індивідуальне заняття, пропуск >= 2 занять\n"
                    #  "Шептицький або Сокаль"
